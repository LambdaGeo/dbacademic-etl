...
config_dags = {
    "mapeamento": {
        ...
        "cursos": {
            ...
            "id"            : ["id","id_curso","idcurso","i_n_e_p","_id",'codigo',"co_curso",'cod_curso','codigo_do_curso','codigo_de_curso'],
            "codigo"        : ["id","id_curso","idcurso","i_n_e_p","_id",'codigo',"co_curso",'cod_curso','codigo_do_curso','codigo_de_curso'],
